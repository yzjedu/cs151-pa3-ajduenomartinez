...
- Should have worked for uppercase or lowercase; L/l, C/c or R/r. You could have done that using the LOWER and UPPER function.  
- There is redundant code in the lines function. You could have just written a function to accept a number. 
- 
